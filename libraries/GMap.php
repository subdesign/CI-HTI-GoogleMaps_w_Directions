...
class Gmap {
     ...
     * @var string
     */
    var $js_alert = '<b>Javascript bekapcsolása szükséges a Google Maps működéséhez!</b>';
    ...
    function getHeaderJS() {
        ...
        $_headerJS .= "<script type='text/javascript' src='http://maps.google.com/maps/api/js?sensor=".(($this->mobile==true)?"true":"false")."&language=en'></script>";
